...
## 건강: 텔미칸(텔미사르탄)과 오래 달리기

- [텔미칸정](https://www.health.kr/searchDrug/result_drug.asp?drug_cd=2012121400001)의 주성분은 텔미사르탄(Telmisartan)이다.
    - 약학정보원 기준 텔미칸정80mg은 `Telmisartan 텔미사르탄 80mg`, 텔미칸정20mg은 텔미사르탄으로서 20mg이다.
    - 적응증은 본태성 고혈압, ACE 억제제를 쓸 수 없는 고위험 환자의 심혈관 질환 위험 감소로 안내된다.
- 텔미사르탄은 안지오텐신 II 수용체 차단제(ARB)라서 혈관 수축을 줄여 혈압을 낮추는 약이다.
    - 혈압이 안정적으로 조절되면 장기적으로 심혈관 부담을 줄이는 방향으로 작용할 수 있다.
    - 반대로 오래 달리기 중에는 땀, 탈수, 염분 손실, 더위로 혈압이 더 내려갈 수 있어 어지러움·기립성 저혈압·무기력감이 생기면 즉시 강도를 낮추거나 중단하는 쪽이 안전하다.
- [미국 FDA 라벨](https://api.fda.gov/drug/label.json?search=openfda.generic_name:%22TELMISARTAN%22&limit=1)도 체액/염분이 부족한 사람에게 증상성 저혈압이 생길 수 있고, 신장 기능·고칼륨혈증·NSAID 병용을 주의하라고 안내한다.
    - 장거리주 후 이부프로펜 같은 NSAID를 습관적으로 먹는 것은 탈수 상태의 신장 부담과 겹칠 수 있으니 의사·약사와 상의한다.
    - 칼륨 보충제, 저염 소금, 이뇨제 등과 같이 복용 중이면 혈중 칼륨과 신장 기능 모니터링 필요성이 커진다.
- 실전 체크포인트
    - 새 용량으로 시작했거나 증량 직후에는 장거리·고강도 달리기보다 짧은 조깅에서 반응을 확인한다.
    - 더운 날, 공복, 음주 다음 날, 설사·구토 후에는 탈수와 저혈압 위험이 커질 수 있다.
    - 달리기 중 흉통, 실신 느낌, 심한 어지러움, 평소와 다른 숨참이 있으면 운동을 멈추고 진료를 우선한다.
    - 복용 시간 조정이나 중단은 임의로 하지 말고 처방한 의료진과 상의한다.
